...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .col-sha { width: 90px; font-family: var(--vscode-editor-font-family); }
  ...
  <form id="form">
    <section class="filters-inline">
      <div class="field">
        ...
        <div class="input-shell">
          ...
          <button type="button" class="field-clear" data-target="message" aria-label="Clear message" title="Clear">×</button>
        </div>
      </div>
      <div class="field">
        ...
        <div class="input-shell">
          ...
          <button type="button" class="field-clear" data-target="branch" aria-label="Clear branch" title="Clear">×</button>
          <div id="branch-list" class="autocomplete-list" role="listbox" aria-label="Branch suggestions"></div>
        </div>
      </div>
      <div class="field">
        ...
        <div class="input-shell">
          ...
          <button type="button" class="field-clear" data-target="author" aria-label="Clear author" title="Clear">×</button>
          <div id="author-list" class="autocomplete-list" role="listbox" aria-label="Author suggestions"></div>
        </div>
      </div>
      <div class="field">
        ...
        <div class="input-shell">
          ...
          <button type="button" class="field-clear" data-target="since" aria-label="Clear since" title="Clear">×</button>
        </div>
      </div>
      <div class="field">
        ...
        <div class="input-shell">
          ...
          <button type="button" class="field-clear" data-target="until" aria-label="Clear until" title="Clear">×</button>
        </div>
      </div>
    </section>
    ...
    <section class="commit-preview">
      ...
      <div class="preview-table-wrap">
        <table>
          <thead>
            <tr><th class="col-sha">SHA</th><th>Subject</th><th>Author</th><th class="col-date">Date</th></tr>
          </thead>
  ...
  <script>
    ...
    function renderPreview() {
      ...
      previewBody.innerHTML = shown.map((commit) => {
        const shortSha = escapeHtml(commit.shortSha || String(commit.sha || '').slice(0, 8));
        ...
        const dateText = Number.isFinite(date.getTime())
          ? escapeHtml(date.toLocaleString(undefined, { dateStyle: 'medium', timeStyle: 'short' }))
          : '';
        return '<tr><td class="col-sha">' + shortSha + '</td><td title="' + subject + '">' + subject + '</td><td title="' + author + '">' + author + '</td><td class="col-date">' + dateText + '</td></tr>';
      }).join('');
    }
